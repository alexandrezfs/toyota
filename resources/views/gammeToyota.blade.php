        ...
        <div class="container">
            <div class="inner-page row">
                ...
                <form method="post" action="#" class="listing_sort">
                    ...
                    <div class="clearfix"></div>
                    @if(count($cars) == 0)
                        <p>Aucun véhicule de la gamme Toyota n'est en vente pour l'instant.
                            <br>
                                ...
                                <div class="inventory margin-bottom-20 clearfix scroll_effect fadeIn">
                                    <a class="inventory" href="{{url('/vehicule/' . $car['slug'])}}">
                                        ...
                                        <div style="margin-top: 45px;">
                                            <img src="http://img4.wikia.nocookie.net/__cb20121221081105/logopedia/images/0/05/Toyota_Logo_silver.svg.png"
                                                 alt="carfax"
                                                 class="carfax"/>
