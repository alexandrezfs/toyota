...
@section('seo')
    <title>TOYOTA LYON EST</title>
    <meta name="description" content="Bienvenue chez Toyota Lyon Est. Véhicules neufs et d'occasion, réparateur véhicules agréé Toyota et Lexus à LYON. Réparations et entretiens toutes marques.">
        ...
        <div class="container">
            <div class="row">
                <h1 class="col-lg-9 col-md-8 col-sm-12 col-xs-12 xs-padding-left-15" style="font-size: 2.0em; padding: 0; margin: 0;">Votre garage <strong>Toyota Lyon</strong> Est
                    à <span class="alternate-font">vous souhaite une bonne et heureuse année 2016 !</span></h1>
