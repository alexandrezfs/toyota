                        ...
                        <div class="inventory_box car_listings boxed boxed_full">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                <div class="inventory margin-bottom-20 clearfix scroll_effect fadeIn">
                                    <a class="inventory" href="{{url('/produit/' . $piece['slug'])}}">
                                        <div class="title">{{$piece['titre']}}</div>
                                        @if(count($piece['images']) > 0)
                                            <img src="{{$piece['images'][0]['uri']}}" alt=""
                                        ...
                                        <table class="options-primary">
                                            <tr>
                                                <td class="option primary">Prix:</td>
                                                <td class="spec">{{$piece['prix']}} €</td>
                                            </tr>
                                            <tr>
                                                <td class="option primary">Frais de port:</td>
                                                <td class="spec">{{$piece['prix_port']}} €</td>
                                            </tr>
                                            <tr>
                                                <td class="option primary">Réf:</td>
                                                <td class="spec">{{$piece['code']}}</td>
                                            </tr>
                                        </table>
